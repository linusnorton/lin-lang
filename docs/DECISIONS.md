...
## ADR-046: `Json` is a covariant sink — closing the Json→concrete cast hole
...
## ADR-047: `fromJson` — type-directed JSON decode (descriptor-driven runtime interpreter)
