...
impl<'ctx> Codegen<'ctx> {
    ...
    /// env_size@24, default-arg descriptor@32, capture descriptor@40 (ADR-053). All closures
    ...
    /// env@16, env_size@24, default-arg descriptor@32, capture descriptor@40 (ADR-053). The
    ...
    pub(crate) fn make_closure_struct_desc_caps(
        ...
        // descriptor@32 + CAPTURE descriptor@40 (ADR-053). The capture descriptor records each
